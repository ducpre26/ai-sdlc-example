...
6. Nếu còn thiếu dữ liệu quan trọng, hỏi từng vòng từ ba đến năm câu dựa trên input tối thiểu bên dưới, rồi tóm tắt sự thật, quyết định, giả định và câu hỏi mở. Sau khi chọn Initiation, invoke `sdlc-project-initiation` bằng Skill tool cho discovery chuyên môn; không hỏi toàn bộ danh sách trong một lượt.
